	...
	<div class="container">
				...
				<div class="panel-freeciv">
                    ...
                    <div class="col-md-6">
		                  <div class="vcontainer">
                                        <iframe  src="https://www.youtube.com/embed/uQM40KHsT1U" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen class="video"></iframe>
                                        </div>
                                  </div>
		...
		<c:if test="${default_lang}">
			...
			<div class="row">
				...
				<div class="col-md-4">			
  			              <iframe src="https://discord.com/widget?id=960605237775855676&theme=dark" width="400" height="300" allowtransparency="true" frameborder="0" sandbox="allow-popups allow-popups-to-escape-sandbox allow-same-origin allow-scripts"></iframe>
				</div>
			</div> <!-- end developers -->
		</c:if>
